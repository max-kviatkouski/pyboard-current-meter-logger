...
def main():
    ...
    pyb.exec_raw(
        ...
        "rtc_time_str = '({{0}}, {{1}}, {{2}}, {{3}}, {{4}}, {{5}}, {{6}})'.format(rtc_time[0], rtc_time[1], rtc_time[2], rtc_time[4], rtc_time[5], rtc_time[6], rtc_time[7])\n"
        "t_real = ({0},{1},{2},{3},{4},{5},{6})\n"
        ...
        "    f.flush()\n"
        "    f.close()\n"
        "".format(now.year, now.month, now.day, now.hour, now.minute, now.second + 1, 0),
